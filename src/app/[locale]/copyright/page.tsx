...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Missiles vs Cities Wiki',
    description: 'Copyright and intellectual property information for Missiles vs Cities Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Missiles vs Cities Wiki',
      description: 'Copyright and intellectual property information for Missiles vs Cities Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Missiles vs Cities Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Missiles vs Cities Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Missiles vs Cities Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Missiles vs Cities Developer</strong> - Creators of the Missiles vs Cities game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Missiles vs Cities</strong> - Trademark of the game developers</li>
              <li><strong>Missiles vs Cities Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Missiles vs Cities Wiki.
            </p>
            ...
            <p>
              ...
              Missiles vs Cities Wiki<br />
              Email: <a href="mailto:dmca@missilesvscities.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@missilesvscities.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Missiles vs Cities Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Missiles vs Cities Wiki (missilesvscities.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@missilesvscities.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@missilesvscities.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@missilesvscities.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@missilesvscities.wiki</a>
            </p>
            <p>
