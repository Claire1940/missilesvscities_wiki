...
export async function GET() {
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.missilesvscities.wiki'
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'Missiles vs Cities Wiki'
